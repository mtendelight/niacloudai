...
class DailyTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily_task" do
    assert_difference("DailyTask.count") do
      post daily_tasks_url, params: { daily_task: { notes: @daily_task.notes, status: @daily_task.status, task_date: @daily_task.task_date, title: @daily_task.title } }
    end
  ...
  test "should update daily_task" do
    patch daily_task_url(@daily_task), params: { daily_task: { notes: @daily_task.notes, status: @daily_task.status, task_date: @daily_task.task_date, title: @daily_task.title } }
