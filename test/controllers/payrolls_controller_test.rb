...
class PayrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payroll" do
    assert_difference("Payroll.count") do
      post payrolls_url, params: { payroll: { allowances: @payroll.allowances, basic_salary: @payroll.basic_salary, deductions: @payroll.deductions, employee_id: @payroll.employee_id, net_salary: @payroll.net_salary, status: @payroll.status } }
    end
  ...
  test "should update payroll" do
    patch payroll_url(@payroll), params: { payroll: { allowances: @payroll.allowances, basic_salary: @payroll.basic_salary, deductions: @payroll.deductions, employee_id: @payroll.employee_id, net_salary: @payroll.net_salary, status: @payroll.status } }
