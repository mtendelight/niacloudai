...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference("Mark.count") do
      post marks_url, params: { mark: { grade: @mark.grade, student_id: @mark.student_id, unit_id: @mark.unit_id, value: @mark.value } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { grade: @mark.grade, student_id: @mark.student_id, unit_id: @mark.unit_id, value: @mark.value } }
