...
class ContractorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contractor" do
    assert_difference("Contractor.count") do
      post contractors_url, params: { contractor: { contact_person: @contractor.contact_person, kra_pin: @contractor.kra_pin, location: @contractor.location, name: @contractor.name, phone: @contractor.phone, scope: @contractor.scope } }
    end
  ...
  test "should update contractor" do
    patch contractor_url(@contractor), params: { contractor: { contact_person: @contractor.contact_person, kra_pin: @contractor.kra_pin, location: @contractor.location, name: @contractor.name, phone: @contractor.phone, scope: @contractor.scope } }
