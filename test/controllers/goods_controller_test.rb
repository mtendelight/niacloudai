...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference("Good.count") do
      post goods_url, params: { good: { description: @good.description, distance: @good.distance, name: @good.name, price: @good.price, quantity: @good.quantity } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { description: @good.description, distance: @good.distance, name: @good.name, price: @good.price, quantity: @good.quantity } }
